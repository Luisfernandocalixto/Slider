...
let progress = document.querySelector(".progress5")
...
function cargandoImg() {
    ...
    uploadTask.on(
        ...
        (snapshot) => {
            ...
            // M.toast({ html: 'Cambio en progreso' })
            M.toast({ html: 'Cambio en progreso' })

        }, (error) => {
            console.log("Error");
            M.toast({ html: 'Cambio en progreso', classes: 'error' })
...
let fileName2
function getFile2(e) {
    document.getElementById('marque2').removeAttribute('disabled')
...
let fileName3
function getFile3(e) {
    document.getElementById('marque3').removeAttribute('disabled')
...
let fileName4
function getFile4(e) {
    document.getElementById('marque4').removeAttribute('disabled')
